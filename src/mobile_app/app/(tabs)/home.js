...
export default function HomeScreen() {
    ...
    const { openFileEditor, openFolderRenamer, setOnRefresh } = useFileEditor();
    ...
    const fetchFiles = async () => {
        try {
            ...
            const result = await apiRequest('/api/files?parentId=null', 'GET', null, token);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <FileActionsMenu
                ...
                onRename={() => openFolderRenamer(selectedFile)}
            />
            {/* THE SHARE MODAL */}
            <ShareModal
